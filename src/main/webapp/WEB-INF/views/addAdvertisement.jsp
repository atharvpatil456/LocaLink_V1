...
<body>
    ...
    <section id="forms-section">
        ...
        <div id="login-form" class="form-container active">
            ...
            <form action="/advertisement/addAdvertisement" method="post">
                <div class="form-group">
                    <label for="adName">Ad Name:</label>
                    <input type="text" id="adName" name="adName" required placeholder="Enter ad name">
                        <input type="hidden" name="rating" value="0" />
    <input type="hidden" name="ratingCount" value="0" />
                </div>
                
                <div class="form-group">
                    <label for="adDesc">Ad Description:</label>
                    <textarea id="adDesc" name="adDesc" required placeholder="Enter ad description"></textarea>
                </div>
                
                <div class="form-group">
                    <label for="adPrice">Ad Price:</label>
                    <input type="number" step="0.01" id="adPrice" name="adPrice" required placeholder="Enter ad price">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.0001" id="latitude" name="latitude" readonly required placeholder="Select on map">
                </div>
                
                <div class="form-group">
                    <label for="longitude">Longitude:</label>
                    <input type="number" step="0.0001" id="longitude" name="longitude" readonly required placeholder="Select on map">
                </div>
